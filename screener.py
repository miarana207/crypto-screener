...
def screen_spot(assets: List[Dict[str, Any]], quote_assets: Optional[set[str]] = None) -> Tuple[List[Dict[str, Any]], CriterionAudit]:
...
def run_spot(warnings: List[str]) -> Tuple[List[Dict[str, Any]], CriterionAudit]:
    ...
    return screen_spot(assets, effective_quotes)
