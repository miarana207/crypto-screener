...
def asset_category(asset: Dict[str, Any]) -> str:
    """Classe les actifs Spot pour éviter de mélanger les tokenized/special assets.

    Binance n'expose pas toujours un attribut public uniforme permettant d'identifier
    ces actifs via le seul endpoint Spot. Le suffixe B est utilisé comme indicateur
    prudent pour les tickers de type AAPLB / NVDAB / QQQB. Cette catégorie est
    descriptive et ne constitue pas une affirmation réglementaire sur l'actif.
    """
...
def spot_top_assets_html(assets: List[Dict[str, Any]]) -> str:
    ...
    html.append(
        ...
        "l'intensité ATR et la liquidité. Aucun signal d'ordre n'est généré.</p>"
    )
    for family, title in groups:
        ...
        html.append(
            ...
            "<th>Depth ±0.25%</th><th>Depth/Volume</th><th>Spread</th><th>Lecture</th></tr>"
        )
...
def spot_conflicts_html(assets: List[Dict[str, Any]]) -> str:
    ...
    html.append(
        ...
        "<th>Volume 24h</th><th>Depth/Volume</th><th>Spread</th><th>Lecture</th></tr>"
    )
...
def market_summary_html(market: str, assets: List[Dict[str, Any]], audit: Optional[CriterionAudit]) -> str:
    ...
    if assets:
        ...
        html.append(
            ...
            f"<th>Depth ±{ORDER_BOOK_DEPTH_PCT:.2f}%</th><th>Depth/Volume</th><th>Spread</th>"
